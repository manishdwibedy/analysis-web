...
/**
 * Servlet implementation class UpdateLaboursServlet
 */
public class UpdateLaboursServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateLaboursServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			column = "";
			UpdateBuilder<Labour, ?> updateBuilder = Connection.getLabourDao().updateBuilder();
		...
		{
			responseObj.setResponse(changes.size() + " Labour(s) Updated.");
		}
