...
/**
 * Servlet implementation class UpdateHiresServlet
 */
public class UpdateHiresServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateHiresServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			column = "";
			UpdateBuilder<Hire, ?> updateBuilder = Connection.getHireDao().updateBuilder();
