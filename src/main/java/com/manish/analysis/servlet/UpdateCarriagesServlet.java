...
/**
 * Servlet implementation class UpdateCarriagesServlet
 */
public class UpdateCarriagesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateCarriagesServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			column = "";
			UpdateBuilder<Carriage, ?> updateBuilder = Connection.getCarriageDao().updateBuilder();
