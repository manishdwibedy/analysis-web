...
// 		}; 
	...
	<script type="text/javascript">
		...
		window.onload = function() { 
			//editableGrid.onloadJSON("grid.json");
 			editableGrid.onloadJSON("./GetHires?mode=edit"); 
		} 
       ...
       <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <jsp:include page="./common/sidebar.jsp">
          	<jsp:param name="page" value="updatehires" />
          </jsp:include>
        </section>
        <!-- /.sidebar -->
      </aside>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Update Hires</li>
          </ol>
        </section>
        ...
        <section class="content">
			...
			<button id="UpdateHires" type="button" class="btn btn-primary btn-block">Update</button>
