       ...
       <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <jsp:include page="./common/sidebar.jsp">
          	<jsp:param name="page" value="updatelabours" />
          </jsp:include>
        </section>
        <!-- /.sidebar -->
      </aside>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Update Labours</li>
          </ol>
        </section>
        ...
        <section class="content">
			...
			<button id="UpdateLabours" type="button" class="btn btn-primary btn-block">Update</button>
