...
// 		}; 
	...
	<script type="text/javascript">
		...
		window.onload = function() { 
			//editableGrid.onloadJSON("grid.json");
 			editableGrid.onloadJSON("./GetCarriages?mode=edit"); 
		...
		$(document).ready( function () {
			...
			$("#UpdateCarriages").click(function() {
				console.log(changes);
				$.ajax({
					url : "./UpdateCarriages",
					data : {
       ...
       <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <jsp:include page="./common/sidebar.jsp">
          	<jsp:param name="page" value="updatecarriages" />
          </jsp:include>
        </section>
        <!-- /.sidebar -->
      </aside>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Carriages</a></li>
            <li class="active">Update Carriages</li>
          </ol>
        </section>
        ...
        <section class="content">
			...
			<button id="UpdateCarriages" type="button" class="btn btn-primary btn-block">Update</button>
