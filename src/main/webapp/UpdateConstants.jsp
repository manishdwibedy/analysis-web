...
// 		}; 
	...
	<script type="text/javascript">
		...
		window.onload = function() { 
			//editableGrid.onloadJSON("grid.json");
 			editableGrid.onloadJSON("./GetConstants?mode=edit"); 
		} 
		...
		$(document).ready( function () {
			...
			$("#UpdateConstants").click(function() {
				console.log(changes);
				$.ajax({
					url : "./UpdateConstants",
					data : {
    ...
    <div class="wrapper">
       ...
       <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <jsp:include page="./common/sidebar.jsp">
          	<jsp:param name="page" value="updateconstants" />
          </jsp:include>
        </section>
        <!-- /.sidebar -->
      </aside>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			...
			<button id="UpdateConstants" type="button" class="btn btn-primary btn-block">Update</button>
